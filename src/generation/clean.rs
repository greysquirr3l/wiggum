...
///
/// Both the new bare filenames (`orchestrator.md`, `planner.md`, etc.) and
/// the deprecated `wiggum-`-prefixed filenames are listed so `wiggum clean`
/// removes stale files from projects generated by older wiggum versions.
const GENERATED_FILES: &[&str] = &[
    "PROGRESS.md",
    "IMPLEMENTATION_PLAN.md",
    "AGENTS.md",
    // opencode target — workflow reference doc at the project root.
    "ORCHESTRATOR.md",
    // VSCode target
    ...
    // opencode target — current bare filenames
