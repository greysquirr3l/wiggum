...
static TEMPLATES: LazyLock<Tera> = LazyLock::new(|| {
    ...
    let templates = [
        ...
        ("opencode_package_json.md", OPENCODE_PACKAGE_JSON_TEMPLATE),
        ("opencode_gitignore.md", OPENCODE_GITIGNORE_TEMPLATE),
...
pub fn get_tera_with_overrides(project_path: &Path) -> Result<Tera> {
    ...
    let flat_names = [
        ...
        "opencode_package_json.md",
        "opencode_gitignore.md",
...
const OPENCODE_PACKAGE_JSON_TEMPLATE: &str = r#"{
  "name": "{{ project_name_slug }}-opencode",
  "private": true,
  "description": "opencode plugin workspace for {{ project_name }} — installed by `wiggum generate`.",
  "dependencies": {
